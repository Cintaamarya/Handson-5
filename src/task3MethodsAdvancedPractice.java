...
public class task3MethodsAdvancedPractice {
    ...
    // Constructor
    public task3MethodsAdvancedPractice(String name) {
    ...
    public static void main(String[] args) {
        ...
        task3MethodsAdvancedPractice obj1 = new task3MethodsAdvancedPractice("Objek1");
        obj1.displayInfo();
